...
const Service = () => {
  ...
  return (
    <>
      ...
      <Title1><Typo size="1.3rem" weight="400">POPCON입니다.<br/><br/>무엇을 도와드릴까요?</Typo></Title1>
      <Horizon width="350px" color="#EBEBEB" />
      <Title1><Typo size="1.1rem" weight="400">자주묻는 질문</Typo></Title1>
      <Wrapper>
    
        <Text>
       <Icon src = {Richat}/>꼭! 읽어주세요. 일부 정책이 변경됩니다.
      ...
      {showText1 ? <IoIosArrowUp size={25} color="gray"/>: <IoIosArrowDown size={25} color="gray"/> }
        ...
        <Body show={showText1}>
         ...
         <Text>
         <Icon src = {Richat}/> [주의] 계정과 비밀번호는 나만 알아야 하는 소중한 정보입니다.
      ...
      {showText2 ? <IoIosArrowUp size={25} color="gray"/>: <IoIosArrowDown size={25} color="gray"/> }
        ...
        <Body show={showText2}>
         ...
         <Text>
         <Icon src = {Richat}/>무더운 여름을 POPCON과 함께!!@@@
