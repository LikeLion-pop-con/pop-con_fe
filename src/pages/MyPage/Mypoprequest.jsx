...
const Mypoprequest = () => {
    return (
        ...
        <Header left="logo" right={["login", "search"]} bgColor="#EC7538"/>
          ...
          <Margin height='20'/>
          <LargeCard image='/Card/PostCardimg1.png' title='NewJeans의 HYPE맑음' popcategory='팝업 스토어' detail='창작 예술' space={'하텍 해동 스룸G \n인하대학교'} date='2023.07.21~2023.08.19'/>
          <LargeCard image='/Card/NewJeans.jpg' title='NewJeans의 HYPE맑음' popcategory='팝업 스토어' detail='창작 예술' space={'하텍 해동 스룸G \n인하대학교'} date='2023.07.21~2023.08.19'/>
          <LargeCard image='/Card/NewJeans.jpg' title='NewJeans의 HYPE맑음' popcategory='팝업 스토어' detail='창작 예술' space={'하텍 해동 스룸G \n인하대학교'} date='2023.07.21~2023.08.19'/>
